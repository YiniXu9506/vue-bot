...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    clickRerun: function () {
      __WEBPACK_IMPORTED_MODULE_0__request_index__["a" /* default */].replayMission(this.mission_id).then(result => {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mockjs__ = __webpack_require__(175);
...
class Ajax {
  getMissions() {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(`${Proxy}/mission`);
  }

  getMissionReportByID(id) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(`${Proxy}/mission/${id}/report`);
  }

  getMissionDetailByID(id) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(`${Proxy}/mission/${id}`);
  }

  stopMissionByID(id) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(`${Proxy}/mission/${id}/stop`);
  }

  startMission(data) {
    console.log(data);
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(`${Proxy}/mission`, data);
  }

  updateMission(data) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.put(`${Proxy}/mission/${data.id}`, data);
  }

  getCasesTemplate() {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(`${Proxy}/case/template`);
  }

  getCaseTemplateByName(name) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(`${Proxy}/case/template/${name}`);
  }

  createCaseTemplate(data) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(`${Proxy}/case/template`, data);
  }

  updateCaseTemplate(data) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.put(`${Proxy}/case/template`, data);
  }

  deleteCaseTemplate(name) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.delete(`${Proxy}/case/template/${name}`);
  }

  getClustersTemplate() {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(`${Proxy}/cluster/template`);
  }

  getClusterTemplateByName(name) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(`${Proxy}/cluster/template/${name}`);
  }

  deleteClusterTemplate(name) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.delete(`${Proxy}/cluster/template/${name}`);
  }

  setClusterTemplate(data) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(`${Proxy}/cluster/template`, data);
  }

  getScenes() {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(`${Proxy}/scenes`);
  }

  getScenesByName(name) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(`${Proxy}/scenes/${name}`);
  }

  deleteScenes(name) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.delete(`${Proxy}/scenes/${name}`);
  }

  setScenes(data) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(`${Proxy}/scenes`, data);
  }

  searchMission(filter) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(`${Proxy}/mission/filter`, filter);
  }

  getMissionByPeriod(period) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(`${Proxy}/mission/period/${period}`);
  }

  release(data) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(`${Proxy}/release`, data);
  }

  replayMission(id) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(`${Proxy}/mission/${id}/replay`);
  }

  replayMissionWithData(id, data) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(`${Proxy}/mission/${id}/replay`, data);
  }

  holdMission(id) {
    return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(`${Proxy}/mission/${id}/hold`);
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__views_MissionView__ = __webpack_require__(178);
...
//# sourceMappingURL=app.eb14e7de6482ec528c8d.js.map